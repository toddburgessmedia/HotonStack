...
/**
 * Created by Todd Burgess (todd@toddburgessmedia.com on 20/03/17.
 */

public class TimeFAQDialog extends DialogFragment {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                ...
                .setItems(R.array.time_dialog, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        EventBus.getDefault().post(new TimeFrameFAQMessage(which));
                    }
                });
